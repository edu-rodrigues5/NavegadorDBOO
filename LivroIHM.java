...
public class LivroIHM extends javax.swing.JFrame {
    ...
    private void mostrarLivro(Livro ex)
    {
        if (ex == null)
            javax.swing.JOptionPane.showMessageDialog(null, Erro.getMens());
        else
        {
            tf1.setText(ex.getTitulo());
            tf2.setText(ex.getAutor());
            tf3.setText(ex.getEditora());
            tf4.setText(ex.getAnoEdicao());
            tf5.setText(ex.getLocalizacao());
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Livro primeiro = LivroDAL.getLivro(2);
        if(primeiro != null){
        mostrarLivro(primeiro);}
        if (Erro.getErro())
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Livro antecessor = LivroDAL.getLivro(3);
        if(antecessor != null){
        mostrarLivro(antecessor);}else{JOptionPane.showMessageDialog(null,"Impossível");}
        if (Erro.getErro())
           JOptionPane.showMessageDialog(null,Erro.getMens());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Livro proximo = LivroDAL.getLivro(4);
        if(proximo != null){
        mostrarLivro(proximo);}else{JOptionPane.showMessageDialog(null,"Impossível");}
        if (Erro.getErro())
           JOptionPane.showMessageDialog(null,Erro.getMens());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        Livro ultimoLivro = LivroDAL.getLivro(5);
        if(ultimoLivro != null){
        mostrarLivro(ultimoLivro);}
        if (Erro.getErro())
           JOptionPane.showMessageDialog(null,Erro.getMens());
        else
           JOptionPane.showMessageDialog(null,"Último Livro");
    }                                        
